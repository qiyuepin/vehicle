    ...
    <div class="app-container">
        <el-form v-if="searchShow" :inline="true" :model="query" class="demo-form-inline" size="small">
            <el-form-item label="关键字">
                <el-input v-model="query.keywords" placeholder="名称|城市" clearable></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <el-table
            ...
            <el-table-column
                    v-if="hasPermission('admin.tank.add')"
                    fixed="right"
                    label="操作"
                    align="center"
                    min-width="150">
...
import { getlist, del, getinfo } from '@/api/tank.js'
...
export default {
  ...
  methods: {
    ...
    handleDetail(raw){
      ...
      this.$refs.myAttrdetail.getinfo(raw.id)
