    ...
    >
        <div class="demo-drawer__content" style="padding: 10px">
            ...
            <el-descriptions :column="2" border>
                ...
                <el-descriptions-item label="自重" class="custom-descriptions">{{formData.trailer_weight}}</el-descriptions-item>
                <el-descriptions-item label="容积" class="custom-descriptions">{{formData.trailer_volume}}</el-descriptions-item>
