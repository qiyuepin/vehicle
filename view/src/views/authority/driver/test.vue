    ...
    <div class="app-container">
        ...
        <el-row style="margin-bottom: 10px;">
            ...
            <el-tooltip class="item" effect="dark" content="违章信息" placement="top">
                <el-button type="danger" v-permission="'auth.admin.adddriver'" icon="el-icon-warning-outline" circle @click="handleRegulation"></el-button>
            </el-tooltip>
            ...
            <el-tooltip class="item" effect="dark" content="test" placement="top">
                <el-button type="danger" v-permission="'admin.driver.test'" icon="el-icon-warning" circle @click="handletest"></el-button>
            </el-tooltip>
