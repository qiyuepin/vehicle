<template>
    <div class="app-container">
        ...
        <el-row style="margin-bottom: 10px;">
            <el-tooltip class="item" effect="dark" content="刷新11" placement="top">
                <el-button type="warning" icon="el-icon-refresh" circle @click="handleReload"></el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" content="新增" placement="top">
                <el-button type="success" v-permission="'auth.admin.add'" icon="el-icon-plus" circle @click="handleAdd"></el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" content="违章信息" placement="top">
                <el-button type="danger" v-permission="'auth.admin.regulation'" icon="el-icon-warning-outline" circle @click="handleAdd"></el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" content="事故信息" placement="top">
                <el-button type="danger" v-permission="'auth.admin.accident'" icon="el-icon-warning" circle @click="handleAdd"></el-button>
            </el-tooltip>
