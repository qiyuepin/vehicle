            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    ...
                    <el-tooltip class="item" effect="dark" content="违章信息" placement="top">
                        <el-button size="mini" type="danger" v-permission="'admin.driver.addregulation'"  icon="el-icon-warning-outline" circle @click="handleRegulation([scope.row.id])"></el-button>
                    </el-tooltip>
...
export default {
  ...
  methods: {
    ...
    handleRegulation(raw) {
      ...
      console.log(raw.id)
      console.log(raw[0])
      // this.$refs.myAttr.regulation(raw.id)
      // this.$router.push('/driver/regulation')
      // this.$router.push({ path: '/driver/regulation', params: { id: 123 }});
