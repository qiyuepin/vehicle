...
<!--        <lang-select class="right-menu-item hover-effect" />-->
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="hover" @command="handleCommand">
        ...
        <el-dropdown-menu slot="dropdown" >
          <el-dropdown-item icon="el-icon-user-solid" command="gome">个人中心</el-dropdown-item>
          <el-dropdown-item divided icon="el-icon-circle-close" command="logout">退出登录</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
    </div>
  </div>
